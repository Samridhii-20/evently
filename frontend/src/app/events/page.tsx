        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredEvents.map((event) => {
            return <EventCard
              ...
              date={event.date}
              image={event.eventImage ? (event.eventImage.startsWith('http') ? event.eventImage : `${process.env.NEXT_PUBLIC_BACKEND_URI}${event.eventImage.startsWith('/') ? event.eventImage : `/${event.eventImage}`}`) : '/placeholder-event.svg'}
