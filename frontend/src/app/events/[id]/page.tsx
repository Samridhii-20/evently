    ...
    <div className="container mx-auto px-4 py-12">
      <Card className="max-w-4xl mx-auto overflow-hidden">
        <div className="relative w-full h-[400px] overflow-hidden">
          <Image
            src={event.eventImage ? (event.eventImage.startsWith('http') ? event.eventImage : `${process.env.NEXT_PUBLIC_BACKEND_URI}${event.eventImage.startsWith('/') ? event.eventImage : `/${event.eventImage}`}`) : '/placeholder-event.svg'}
            alt={event.title}
            fill
